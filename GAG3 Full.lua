...
shI.Text="Auto Buy: bat trong Automatically | Seed: "..CFG.SeedName.." | Gear: "..CFG.GearName..CFG.SeedName.."\n  Gear: "..CFG.GearName
...
HQBtn.Size = UDim2.new(0, 38, 0, 38)
...
HQBtn.MouseButton1Click:Connect(function()
    local now = tick()
    if now - lastTap < 0.3 then return end -- debounce
    lastTap = now
