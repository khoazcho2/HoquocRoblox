...
Win.Name = "Win"
Win.Size = UDim2.new(0,570,0,350)
Win.Position = UDim2.new(0.5,-285,0.5,-175)
...
MinB.MouseButton1Click:Connect(function()
    ...
    TweenService:Create(Win, TweenInfo.new(0.2), {
        Size = minimized and UDim2.new(0,570,0,34) or UDim2.new(0,570,0,350)
    }):Play()
...
task.spawn(function()
    while hStatL and hStatL.Parent do
        ...
        hStatL.Text = #t > 0 and ("ON: "..table.concat(t," | ")) or "Chua bat gi"
        task.wait(1.5)
    end
end)
